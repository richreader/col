...
if (widgetTag === null){ 
	widgetHtml += '<div style="text-align: center; font-size:12px; color:#e2e2e2;margin-top:-40px;"><p><a href="https://writeforbenefits.blogspot.com" target="_blank" style="color:#e2e2e2;" id="ppsLink">Plagiarism Checker</a> provided by <a href="https://www.prepostseo.com/" rel="nofollow noreferrer noopener noindex" target="_blank"  style="color:#e2e2e2;">PrePostSEO</a></p></div>';
	
} else {
	var linkUrl = widgetTag.getAttribute("href");	
	if(linkUrl !== 'https://writeforbenefits.blogspot.com'){
		widgetHtml += '<div style="text-align: center; font-size:12px; color:#333;margin-top:-40px;"><p><a href="https://writeforbenefits.blogspot.com" target="_blank" style="color:#e2e2e2;" id="ppsLink">Plagiarism Checker</a> provided by <a href="https://www.prepostseo.com/" rel="nofollow noreferrer noopener noindex" target="_blank"  style="color:#e2e2e2;">PrePostSEO</a></p></div>';
	}
}
